...
export default function WalletOverview() {
    ...
    const tabs = [
        ...
        { id: 'financial', label: 'Financial Account', icon: <ChartCandlestick size={18} /> },
        { id: 'asset', label: 'Asset Account', icon: <BadgeDollarSign size={18} /> },
                            ...
                            <div className="flex flex-row gap-6">
                                ...
                                <div className="flex-1 relative">
                                    ...
                                    <div className="border-l border-gray-500 relative h-16 lg:h-auto mb-6 lg:mb-0">
                                        ...
                                        >
                                            {isSidebarCollapsed ? <ArrowRightFromLine size={16} /> : <ArrowLeftFromLine size={16} />}
                                        </button>
                                    </div>
