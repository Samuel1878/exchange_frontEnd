  ...
  return (
    <main className="bg-gray-900 lg:bg-gray-950 overflow-x-hidden">
      <section id="hero" className="flex flex-col lg:items-center">
        <article
          id="hero1"
          className="flex flex-col gap-4 lg:gap-y-8 lg:max-w-6xl"
        >
          <div className="lg:max-w-6xl">
            <div className="text-gray-300 p-6 md:p-5 space-y-10">
              <div className="flex flex-col lg:items-center md:items-start lg:flex-row lg:justify-between lg:gap-6">
                <div className="space-y-2 mb-4 lg:space-x-7">
                  ...
                  <p className="text-sm text-gray-600 flex">
                    ...
                    Repayment at any time, early repayment minus interest
                  </p>
                  <p className="text-sm text-gray-600 flex">
                    <GrTransaction className="mr-2" />
                    Optional multi-time staking
                  </p>
                  <p className="text-sm text-gray-600 flex">
                    <FaSackDollar className="mr-2" />
                    Quickly arrive at the account, the annualized interest rate
                    is as low as1%
                  </p>
                  <button className="bg-amber-300 text-gray-800 p-2 rounded-lg lg:w-1/3">
                    Borrow Now
                  </button>
                </div>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full text-sm border-0 border-gray-900">
                  ...
                  <tbody>
                    {tokens.Favorites.map((e) => (
                      <tr
                        key={e.symbol}
                        className="cursor-pointer border-- border-gray-700  hover:bg-gray-800 lg:hover:bg-gray-900"
                  ...
                  <DialogContent className="max-w-lg text-white bg-gray-900 border border-gray-800 rounded-2xl">
                    ...
                    <div className="space-y-3 mt-4">
                      ...
                      <div className="text-xs text-gray-400 flex justify-between">
                        <span>
                          Verifiable Amount: 0 {selectedToken?.symbol}
                        </span>
                      </div>
                    </div>
                    <div className="space-y-3 mt-4">
                      <Label>
                        Evaluate after entering the amount of capital
                        verification
                      </Label>
                      <Input
                        type="number"
