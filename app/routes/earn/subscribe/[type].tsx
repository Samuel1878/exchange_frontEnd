                        ...
                        <div className="text-gray-300 p-6 md:p-5 space-y-10">
                            <div className="grid grid-cols-3 gap-5">
                                <div className="col-span-3 lg:col-span-1">
                                    <h2 className="text-2xl font-semibold mb-4 text-white">Subscribe to {selectedAsset} Earn</h2>
                                    <p className="text-gray-400 mb-6">Earn rewards by subscribing to our {selectedAsset} Earn program. Choose your subscription amount and enjoy competitive interest rates.</p>
                                ...
                                <div className="col-span-3 lg:col-span-2 mt-10 lg:mt-0">
                                    <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
                                        <h3 className="text-xl font-semibold mb-4 text-white">Subscription Summary</h3>
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                <span className="text-white">{subscriptionAmount ? `${subscriptionAmount} ${selectedAsset}` : '-'}</span>
                                            </div>
                                            <div className="flex justify-between">
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                <span className="text-white">3500-999999999 {selectedAsset}</span>
                                            </div>
                                            <div className="flex justify-between">
                            ...
                            <div className="space-y-6 text-white">
                                <h3 className="text-xl font-semibold">Advanced Earn Portfolio</h3>
                                <div className="">
                                    ...
                                    {!loading && (
                                        <>
                                            {DepositData.length > 5 ? (
                                                <>
                                                    {DepositData.map((r) => (
                                                        <div key={r.crypto} className="grid grid-cols-6 border p-2 border-gray-700 py-2 rounded-2xl gap-2 mt-3 text-center items-center">
                                                            <div className="">
