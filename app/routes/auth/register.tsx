...
function SubmitButton({
  ...
  return (
    <button
      type="submit"
      className="bg-amber-300 w-full py-3 rounded text-gray-950 font-bold disabled:opacity-60"
      disabled={!!loading}
    >
...
function SendCodeButton({
  ...
  return (
    <button
      ...
      className="bg-gray-800 p-3 rounded px-6 cursor-pointer disabled:opacity-60"
      disabled={disabled}
    >
...
type MobileFormProps = {
  ...
  const MobileForm: React.FC<MobileFormProps> = ({ value, onChange }) => {
    const {
      inputValue,
    ...
    return (
     <FormContainer>
          <div className="h-12 w-full items-center bg-gray-900 lg:bg-gray-950 flex gap-2 ">
            <Select onValueChange={(e) => setCountry(e)} defaultValue={"us"}>
              <SelectTrigger className=" bg-gray-900 border max-w-1/3 lg:bg-gray-950 lg:border-gray-950 border-gray-800 rounded-lg py-6 px-3 text-gray-300 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-900">
                <SelectValue>
                  {/* <FlagImage iso2={value} style={{ width:"10px" }} /> */}
                </SelectValue>
              </SelectTrigger>
            ...
            <input
              ...
              type="tel"
              ref={inputRef}
              className="w-full h-full pl-2 min-w-2/3 outline-0 bg-gray-900 lg:bg-gray-950 rounded-sm border-1 border-gray-800 rounded-sm focus:border-transparent focus:outline-none focus:ring-2 focus:ring-gray-800 lg:focus:ring-gray-900"
            />
          </div>
          <div className="flex flex-row gap-3">
            <div className="text-white w-full">
              <input
                ...
                className="w-full border-gray-800 lg:border-gray-800 border rounded-md px-3 py-3 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-gray-800 lg:focus:ring-gray-900"
              />
            </div>
            <div className="text-white basis-64">
              <button className="bg-gray-800 p-3 rounded px-20 cursor-pointer">
                Send
              </button>
            </div>
          </div>
                    ...
                    <div className="space-y-7 flex-1 py-10 justify-center">
                      <div className="flex flex-col items-center md:items-start">
                        <div className="text-3xl font-extrabold space-y-4 lg:text-4xl mb-4">
                          <h1>
                            Up to{" "}
                            <span className="text-amber-300">100 USD</span>
                          </h1>
                    ...
                    <div className="flex flex-1 gap-7 flex-col">
                      ...
                      <div className="overflow-x-auto [-ms-overflow-style:none] [scrollbar-width:none] touch-pan-x pb-6">
                        ...
                        >
                          {LoginTab.map(({ symbol, label }) => (
                            <div
                              key={symbol}
                              className="flex-shrink-0 w-65ss scroll-snap-align-start"
                            >
                              <button
                                ...
                                ${activeTab === symbol ? "text-gray-100 border-b-2 border-amber-300" : "text-gray-400 hover:text-gray-100"}`}
                              >
                                {label}
                              </button>
                            </div>
                      ...
                      <div className="space-y-7">
                        {loading ? (
                          ...
                          <>
                            {activeTab === "mobile" && (
                              <MobileForm value={phone} onChange={setPhone} />
                            )}
                      ...
                      <div className="text-white">
                        <button className="bg-amber-300 w-full py-3 rounded text-gray-950 font-bold">
                          Continue
                        </button>
                      </div>
...
//   return (
//     <FormContainer>
//       <div className="h-12 w-full items-center bg-gray-900 lg:bg-gray-950 flex gap-2 rounded">
//         <Select
//           onValueChange={(e) => setCountry(e)}
//           defaultValue={country?.iso2 ?? "us"}
//         >
//           <SelectTrigger className="bg-gray-900 border max-w-1/3 lg:bg-gray-950 lg:border-gray-950 border-gray-800 rounded-lg py-6 px-3 text-gray-300 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-900">
//             <SelectValue />
//           </SelectTrigger>
...
//                     </div>
//                     <div className="text-sm">+{c.dialCode}</div>
//                   </SelectItem>
//                 );
//               })}
//             </SelectGroup>
...
//           type="tel"
//           ref={inputRef as any}
//           className="w-full h-full pl-2 min-w-2/3 outline-0 bg-gray-900 lg:bg-gray-950 rounded-sm border-1 border-gray-800 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-gray-800 lg:focus:ring-gray-900 text-white"
//         />
//       </div>

//       <div className="flex flex-row gap-3">
//         <div className="text-white w-full">
//           <FormInput placeholder="Please enter the verification code" />
//         </div>
//         <div className="text-white basis-64">
//           <SendCodeButton
//             onSend={handleSend}
...
//         placeholder="please enter your login password again"
//       />
//       <FormInput placeholder="Please enter the invitation code" />
//     </FormContainer>
//   );
// };
...
//     <FormContainer>
//       <div>
//         <FormInput type="email" placeholder="Please enter your Email" />
//       </div>
...
//         </div>
//         <div className="text-white basis-64">
//           <SendCodeButton onSend={handleSend} seconds={seconds} disabled={disabled} />
//         </div>
//       </div>

//       <FormInput type="password" placeholder="Please enter your login password" />
//       <FormInput
//         type="password"
//         placeholder="please enter your login password again"
//       />
...
//         <div className="text-white w-full">
//           <FormInput placeholder="Enter the words beside" />
//         </div>
//         <div className="text-white">
//           <LoadCanvasTemplate />
//         </div>
...
// export default function Registration() {
//   const [activeTab, setActiveTab] = useState<LoginTabKey>("mobile");
//   const [loading, setLoading] = useState(false);
//   const [phone, setPhone] = useState<string>("");

//   // main form handler (you can wire separate RHF instances per form if desired)
...
//     setTimeout(() => setLoading(false), 900); // placeholder
//   }
...
//     <main className="bg-gray-900 lg:bg-gray-950 min-h-screen overflow-x-hidden">
//       <section id="hero" className="flex flex-col lg:items-center">
//         <article className="flex flex-col gap-4 lg:gap-y-8 lg:max-w-6xl w-full">
//           <div className="w-full lg:py-10">
//             <div className="text-gray-300 p-6 md:p-5 lg:space-y-10">
//               <div className="flex flex-col-reverse md:flex-row gap-4">
//                 <div className="space-y-7 flex-1 py-10 justify-center">
...
//                   <div className="flex flex-row gap-4">
//                     <svg /* ...icon omitted for brevity - keep original if you want */ />
//                     <p>25,541,439 Users Trust {TitleSuffix}</p>
//                   </div>
...
//                 <div className="flex flex-1 gap-7 flex-col">
//                   <Link to="/">
//                     <img src={Logo} className="w-40 z-50 lg:w-40" alt="logo" />
//                   </Link>
...
//                                   field.onChange(v)
//                                 }
//                                 className="data-[state=checked]:border-blue-600 data-[state=checked]:bg-gray-600 data-[state=checked]:text-white dark:data-[state=checked]:border-gray-700 dark:data-[state=checked]:bg-gray-700"
//                               />
//                             )}
//                           />
//                           <div className="grid gap-2">
//                             <p className="text-sm text-gray-400">
//                               Please ensure the security of your account. When
//                               you click confirm and log in, you agree to use our
//                               <Link to={`/term`} className="underline text-white">
//                                 &nbsp;Terms of Service
//                               </Link>
//                               &nbsp; and
...
//                         <Label htmlFor="terms-2" className="mt-2">
//                           Already have an account?{" "}
...
//                 {/* NOTE: legacy/hardcoded blocks were trimmed for clarity.
//                        If you need the extra repeated promo columns, re-add them. */}
//               </div>
//             </div>
//           </div>
//         </article>
