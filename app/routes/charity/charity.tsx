              ...
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 p-6 max-w-6xl mx-auto">
                  ...
                  <div className="relative w-full max-w-md aspect-square">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center space-x-0 space-y-2">
                      <div className="items-center text-center space-y-2 mb-4">
                        <h3 className="text-3xl font-bold text-white">2,085,823</h3>
                        <p className="text-sm font-thin text-gray-300">Total Beneficiaries</p>
                      </div>
                      <div className="items-center text-center space-y-2 mb-4">
                        <h3 className="text-3xl font-bold text-white">12,452</h3>
                        <p className="text-sm font-thin text-gray-300">Amount Donations</p>
                      </div>
                      <div className="items-center text-center space-y-2 mb-4">
                        <h3 className="text-3xl font-bold text-white">1,519 <span className="text-lg">BTC</span></h3>
                        <p className="text-sm font-thin text-gray-300">Bitcoin Donations Raised</p>
                      </div>
                    </div>
                ...
                <div className="lg:w-2/3">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                    <h1 className="text-3xl font-bold text-white mb-4 md:mb-0">Our Approach</h1>
