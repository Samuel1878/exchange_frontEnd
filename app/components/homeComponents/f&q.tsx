...
export default function FAQ({list}) {
  ...
  return (
    <section id="faq" className="lg:flex lg:flex-col lg:items-center w-full">
        ...
        {list.map((data, i) => (
          ...
          >
            <div>
              ...
              >
                <div className="w-8 h-8 hidden md:flex items-center justify-center border-neutral-700 border rounded-md text-sm text-neutral-50 font-mono">
                  {data.id}
                </div>
              ...
              {open.opening && open.value === data.id ? (
                <div className="ml-8 md:ml-15 m-2 mr-7">
