import { ArrowLeftRight, EqualApproximately, Eye, EyeOff, MoreVertical, SearchIcon, Shuffle, SquareArrowOutDownRight, SquareArrowOutUpRight } from "lucide-react";
...
const AssetAccount = ({ setActiveTab, selectedToken }: TransferProps) => {
        ...
        <>
            <div className="border border-gray-700 rounded-2xl p-4 text-white">
                <div className="space-y-7 text-xl">
                    <div className="text-lg flex gap-2">
                        <h2 className="">Asset Account Valuation :{isPriceVisible ? totalPrice : hiddenPrice}&nbsp;<span className="text-sm">USDT</span></h2>
                ...
                <div className="space-y-7 p-2">
                    <div className="grid grid-cols-4 gap-2 text-white">
                        <button className='border-gray-900 border p-2 bg-gray-900 rounded-2xl hover:bg-gray-800 transition-colors flex gap-2'>
            ...
            <div className="p-4 text-white">
                ...
                <div className="space-y-7 py-4">
                    ...
                    <div className="p-4">
                        <div className="grid grid-cols-4 text-sm font-semibold bg-gray-950 border-b border-gray-700 pb-5 mb-4 p-4 text-gray-400">
                            <div>Crypto</div>
                                                ...
                                                <div key={t.symbol} className="grid grid-cols-4 border p-4 border-gray-700 py-2 rounded-2xl gap-2 mt-3">
                                                    ...
                                                    <div className="text-right">
                                                        <div className="flex gap-2">
                                                            ...
                                                            <div className="">
                                                                <button
                                                                    className="border-gray-900 border p-2 bg-gray-900 rounded hover:bg-gray-800 transition-colors cursor-pointer"
                                                                    onClick={() => setActiveTab('transfer')}
                                                                >
                                                                    Transfer
                                                                </button>
