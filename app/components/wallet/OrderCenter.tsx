...
const cryptoTabs = [
  { label: "deposit", Id: "1", name: "Deposit Record" },
  { label: "withdrawal", Id: "2", name: "Withdrawal Record" },
  { label: "loan", Id: "3", name: "Loan Data" },
  { label: "event", Id: "4", name: "Event Contract" },
  { label: "contract", Id: "5", name: "Contract" },
  { label: "ai", Id: "6", name: "AI" },
  { label: "spot", Id: "7", name: "Spot" },
  { label: "investment", Id: "8", name: "Investment Portfolio" },
];
  ...
  return (
    <div className="">
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-lg text-white bg-gray-950 border border-gray-800 rounded-2xl">
          <DialogHeader className="border-b border-gray-800 pb-4 mb-4">
            <DialogTitle className="text-xl font-semibold items-center justify-center text-center">Order Details</DialogTitle>
          </DialogHeader>
          ...
          <div className="space-y-7">
            <div className="flex flex-2 justify-between">
              <div className="space-y-3">
                ...
                <p className="text-gray-400">Time of occurrence</p>
                <p className="text-gray-400">Bill type</p>
                <p className="text-gray-400">Amount</p>
                <p className="text-gray-400">Handling Fee</p>
                <p className="text-gray-400">Status</p>
              </div>
              <div className="space-y-3 text-right">
                <p>{selectedToken?.crypto}</p>
                <p>{selectedToken?.time.date.toLocaleDateString()} {selectedToken?.time.date.toLocaleTimeString()}</p>
                <p>{selectedToken?.bill}</p>
                <p className="text-green-400">+{selectedToken?.amount}</p>
                <p>-</p>
                <p className={`${getStatusColor(selectedToken?.status)}`}>{selectedToken?.status}</p>
              </div>
            </div>
          </div>
        </DialogContent>
  ...
  return (
    <div className="">
      <div className="grid grid-cols-9 text-sm font-semibold bg-gray-950 pb-5 mb-4 text-gray-600">
        ...
        <div className="text-center">Realized PnL%</div>
        <div className="text-right">Maximum Position</div>
      </div>
      {loading && (
        <div className="flex flex-col items-center justify-center my-4 h-52">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-yellow-500"></div>
...
const AI = () => {
  ...
  return (
    <div className="">
      <div className="grid grid-cols-10 text-sm font-semibold bg-gray-950 pb-5 mb-4 text-gray-600">
        <div className="text-center">Crypto</div>
        <div className="text-center">Robot ID</div>
        <div className="text-center">Operating Time</div>
        <div className="text-center">ROI</div>
        <div className="text-center">Investment Amount</div>
        <div className="text-center">Total Profit</div>
        <div className="text-center">Number of Grids</div>
        <div className="text-center">Service Fee</div>
        <div className="text-center">Order Time</div>
  ...
  return (
    <div className="">
      <div className="grid grid-cols-9 text-sm font-semibold bg-gray-950 pb-5 mb-4 text-gray-600">
        ...
        <div className="text-center">Actual Transaction</div>
        <div className="text-center">Actual Quantity</div>
...
const InvestmentPortfolio = () => {
  ...
  return (
    <div className="">
      <div className="grid grid-cols-7 text-sm font-semibold bg-gray-950 pb-5 mb-4 text-gray-600">
        <div className="text-center">Investment Portfolio</div>
        <div className="text-center">Subscription Amount</div>
    ...
    <div className=" text-white">
      ...
      <div className="space-y-7">
        {loading ? (
          ...
          <>
            {activeTab === "deposit" && <DepositRecord />}
            {activeTab === "withdrawal" && <WithdrawalRecord />}
            {activeTab === "loan" && <LoanRecord />}
            {activeTab === "event" && <EventContract />}
            {activeTab === "contract" && <Contract />}
            {activeTab === "ai" && <AI />}
            {activeTab === "spot" && <Spot />}
            {activeTab === "investment" && <InvestmentPortfolio />}
          </>
        )}
      </div>
    </div>
