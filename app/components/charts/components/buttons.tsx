  ...
  return (
    <div className="flex gap-4">
      <div
        ...
        className={`flex gap-1 ${option === "both" ? "opacity-100" : "opacity-30"}`}
      >
        <div className={` flex-col gap-1 flex`}>
      ...
      <div
        ...
        className={`flex gap-1 ${option === "bid" ? "opacity-100" : "opacity-30"}`}
      >
        <div className={` flex-col gap-1 flex`}>
      ...
      <div
        ...
        className={`flex gap-1 ${option === "ask" ? "opacity-100" : "opacity-30"}`}
      >
        <div className={` flex-col gap-1 flex`}>
